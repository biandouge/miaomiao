...
<style scoped>
.messageBox{width: 200px; height: 140px; border: 1px solid #ccc; border-radius: 4px; background: white;box-shadow: 3px 3px 3px 3px #ccc;position: absolute;left: 50%;top: 50%;margin-left: -100px;margin-top: -70px;}
...
.messageBox > div div:last-child{border: 0;}
</style>